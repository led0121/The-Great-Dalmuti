# 🎰 카지노 로비 - 웹 카드게임 플랫폼
# (The Great Dalmuti & Casino Card Games)
...
- **판돈 설정** 가능 (무료/100/500/1,000/5,000)
- **접속자 수** 실시간 표시
- **방 시스템** 생성/입장/관전
- **실시간 채팅**
- **다국어 지원** (한국어/English)
...
├── start.sh                 # 서버+클라이언트 실행 스크립트
├── server/
│   ├── index.js             # Express + Socket.io 서버 (인증, 온라인 카운트)
│   ├── RoomManager.js       # 방 관리 (4게임 지원, 베팅)
│   ├── UserDB.js            # 유저 DB (회원가입, 로그인, 잔고, 일일충전)
│   ├── Game.js              # 달무티 게임 엔진
